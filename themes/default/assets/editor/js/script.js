    ...
    function render(data) {
      ...
      if (scannedFolders.length) {
        scannedFolders.forEach(function(f) {
          ...
          var folder = $('<li class="folders"><div onclick="delletefolder(`' + f.path + '`);" style="font-size: 22px;float: left;padding: 5px;font-weight: 900;background: #999090;position: absolute;bottom: 0;"><img src="/themes/default/assets/editor/icons/svg/delete.svg" alt="" style="width: 20px;"></div><div onclick="renamefolder(`' + f.path + '`);" style="font-size: 22px;float: left;padding: 5px;font-weight: 900;background: #999090;position: absolute;top: 0;"><img src="/themes/default/assets/editor/icons/svg/rename.svg" alt="" style="width: 20px;"></div><a href="' + f.path + '" title="' + f.path + '" class="folders">' + icon + '<span class="name">' + name + '</span><img src="/themes/default/assets/editor/icons/svg/right-arrow.svg" class="rigtharrow"> <span class="details">' + itemsLength + '</span> <span class="details" style=" top: 68px; ">'+ f.time +'</span></a></li>');
      ...
      if (scannedFiles.length) {
        scannedFiles.forEach(function(f) {
          ...
          var file = $('<li class="files"><div onclick="renamefile(`' + f.path + '`);" style="font-size: 22px;float: left;padding: 5px;font-weight: 900;background: #999090;position: absolute;top: 0;"><img src="/themes/default/assets/editor/icons/svg/rename.svg" alt="" style="width: 20px;"></div><div onclick="delletefile(`' + f.path + '`);" style="font-size: 22px;float: left;padding: 5px;font-weight: 900;background: #999090;position: absolute;bottom: 0;"><img src="/themes/default/assets/editor/icons/svg/delete.svg" alt="" style="width: 20px;"></div><a class="files" onclick="open_ace(`' + f.path + '`);" title="' + f.path + '">' + icon + '<span class="name">' + name + '</span> <span class="details">' + fileSize + '</span><span class="details" style=" top: 68px; ">'+ f.time +'</span></a></li>');
